...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-lg-auto text-center">
                        ...
                        <li>
                            <a href="{{route('login')}}">
                                <button type="button" class="btn  ml-lg-2 w3ls-btn nav-link" data-toggle="modal"
        ...
        <div class="container">
            <div class="row  py-lg-5">
                <div class="col-lg-3 col-sm-6 footer-logo">
                    ...
                    <p class="mt-3">Villa yang akan menjadikan kenyamanan pelanggan sebagai prioritas pertama</p>
                </div>
    ...
    <div class="cpy-right text-center py-4">
        <p class="text-white">© 2018 De Villa. All rights reserved </p>
    </div>
    </div>
    <!-- /Footer -->
